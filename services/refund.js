...
var refund = {
	...
	create : function(req , res , next)
	{
		...
		var fieldsToSet = {
		        ...
		        req.app.db.models.Refund.create(fieldsToSet,
		            function(err ,  docs){
	...
	update : function(req , res , next)
	{
		...
		req.app.db.models.Refund.findByIdAndUpdate(id, fieldsToSet ,
	...
	read : function(req , res , next)
	{
		...
		req.app.db.models.Refund.find({apartment: mongoose.Types.ObjectId(id)},
		    function(err , docs)
			{
				if(err)
				{
