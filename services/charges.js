...
var charges = {
	...
	create : function(req , res , next)
	{
		...
		var fieldsToSet = {
		        ...
		        req.app.db.models.Charges.create(fieldsToSet,
		            function(err ,  docs){
	...
	update : function(req , res , next)
	{
		...
		req.app.db.models.Charges.findByIdAndUpdate(id, fieldsToSet ,
	...
	read : function(req , res , next)
	{
		...
		req.app.db.models.Charges.find({apartment: mongoose.Types.ObjectId(id)},
		    function(err , docs)
			{
				if(err)
				{
