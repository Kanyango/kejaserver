...
var maintain = {
	...
	create : function(req , res , next)
	{
		console.log(req.body.units);
        	...
        	var apartment = parseInt(req.body.apartment);
		...
		var fieldsToSet = {
		        ...
		        req.app.db.models.Maintenance.create(fieldsToSet,
		            function(err ,  docs){
	...
	update : function(req , res , next)
	{
		...
		req.app.db.models.Maintenance.findByIdAndUpdate(id, fieldsToSet ,
	...
	read : function(req , res , next)
	{
		...
		req.app.db.models.Maintenance.find({apartment: mongoose.Types.ObjectId(id)},
		    function(err , docs)
			{
				if(err)
				{
